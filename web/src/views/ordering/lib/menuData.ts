...
export const menuDocument: MenuDocument = {
  ...
  "items": [
    ...
    },
    {
      ...
      "description": "Southern Vietnam's milkier, sweeter cup: more milk than coffee over sweetened condensed milk.",
      "categoryId": "ca-phe",
      "temperatures": [
        "hot",
        "iced"
    ...
    },
    {
      ...
      "name": "Egg Coffee",
      "nameVi": "Cà Phê Trứng",
      "description": "Northern Vietnam's custard-cap coffee: strong coffee under a dense egg foam.",
      "categoryId": "ca-phe",
      "temperatures": [
        "hot",
        "iced"
