...
- Ordering kitchen food (`kitchen.html`) and cocktails (`bar.html`, generated from the recipes like the drinks menu): ordering is drinks only; the two pages are still published on the menus site (FR-12)
